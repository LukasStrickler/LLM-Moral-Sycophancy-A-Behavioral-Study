...
from ...benchmark.providers.litellm_provider import LiteLLMProvider
...
async def score_response_async(
    ...
    *,
    ...
    local_client = client or LiteLLMProvider(
        config.provider_config, config.run_config, config.model_configs
    )
