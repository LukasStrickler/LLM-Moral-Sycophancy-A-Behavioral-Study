#!/usr/bin/env python3
"""Seed scored v1 responses from JSONL file into database.

This script loads sampled and scored responses from data/humanLabel/seeds/aita_seed_scored_v1.jsonl
...
INPUT_FILE = PROJECT_ROOT / "data" / "humanLabel" / "seeds" / "aita_seed_scored_v1.jsonl"
...
def main() -> None:
    """Main execution."""
    print("=" * 60)
    print("Seed Scored V1 Responses")
    print("=" * 60)
    print()
